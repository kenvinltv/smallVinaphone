...
<tr>
	<td width="100">Thuộc nhóm</td>
	<td>
		<select name="idLoai">
			<option <?php if($row_sanpham['idLoai'] == 0) echo "selected"?> value="0">Slider Desktop (1000x400)</option>
			<option <?php if($row_sanpham['idLoai'] == 1) echo "selected"?> value="1">Slide Mobile (700x420)</option>
			<option <?php if($row_sanpham['idLoai'] == 2) echo "selected"?> value="2">Gallery Footer (251x157)</option>
		</select>
	</td>
</tr>
