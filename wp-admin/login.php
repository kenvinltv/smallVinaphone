...
<div class="box">
  ...
  <form id="form1" name="form1" method="post" action="">
    ...
    <table>
      <tr>
        <td width="90" height="35"><span class="login">Tên đăng nhập: </span></td>
        <td><input name="username" type="text" class="fields" id="username" size="30" /></td>
      </tr>
      
      
      <tr>
        <td width="90" height="35"><span class="login">Mật khẩu: </span></td>
      ...
      <tr>
        ...
        <td height="65" align="right" valign="middle"><label>
