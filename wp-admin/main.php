					...
					switch ($p)
						{	
							...
							case "clk_xem":
								...
								break;
							case "clk_chinh":
								include "clk_chinh.php";
								break;
							case "clk_them":
								include "clk_them.php";
								break;

							case "ppdt_xem":
								include "ppdt_xem.php";
								break;
							case "ppdt_chinh":
								include "ppdt_chinh.php";
								break;
							case "ppdt_them":
								include "ppdt_them.php";
								break;
							...
							case "blo_xem":
								...
								break;
							case "blo_chinh":
								include "blo_chinh.php";
								break;
							case "blo_them":
								include "blo_them.php";
								break;						
							...
							case "sett_chinh":
								include "sett_chinh.php";
								break;

							case "sett_seo":
								include "sett_seo.php";
								break;
